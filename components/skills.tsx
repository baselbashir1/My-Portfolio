  ...
  const skillCategories = [
    {
      ...
      icon: "☕",
      skills: ["Java 17+", "Spring Boot", "Spring Security", "Spring Data JPA", "Spring Cloud", "Hibernate"],
    },
    {
    ...
    },
    {
      ...
      icon: "🗄️",
      skills: ["PostgreSQL", "MySQL", "MongoDB", "Redis", "Elasticsearch", "Database Design"],
    },
    {
      title: "DevOps & Cloud",
      icon: "☁️",
      skills: ["Docker", "Kubernetes", "AWS", "Jenkins", "GitLab CI/CD", "Terraform"],
    },
    {
      title: "Message Queues & Streaming",
      icon: "📡",
      skills: ["Apache Kafka", "RabbitMQ", "Apache ActiveMQ", "Redis Pub/Sub", "Event Sourcing", "CQRS"],
    },
    {
      title: "Testing & Quality",
      icon: "🧪",
      skills: ["JUnit 5", "Mockito", "TestContainers", "Integration Testing", "SonarQube", "TDD/BDD"],
    },
  ]
            ...
            >
              <CardHeader className="pb-3 sm:pb-4">
                <CardTitle className="flex items-center gap-2 sm:gap-3 text-lg sm:text-xl">
                  ...
                  <span className="text-foreground text-sm sm:text-base lg:text-lg">{category.title}</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
