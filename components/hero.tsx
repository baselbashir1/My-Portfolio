  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0">
        ...
        {/* Glowing orbs */}
        <div className="absolute top-20 left-10 w-3 h-3 sm:w-4 sm:h-4 bg-primary rounded-full animate-pulse shadow-lg shadow-primary/50 pulse-glow"></div>
        <div
      ...
      <div className="container mx-auto max-w-6xl text-center relative z-10 w-full">
        <div className="fade-in-up" style={{ animationDelay: "0.1s" }}>
          ...
          >
            ...
            <div className="text-green-400 text-xs sm:text-sm min-w-max space-y-1">
              ...
              <div>
                ...
                <span className="text-yellow-400">Application</span> <span className="text-white">{"{"}</span>
              </div>
          ...
          <h1
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight slide-in-right"
            style={{ animationDelay: "0.5s" }}
          >
            Hi, I'm{" "}
            <span className="bg-gradient-to-r from-primary via-primary-400 to-secondary bg-clip-text text-transparent relative block sm:inline mt-2 sm:mt-0 pulse-glow">
              Basel
              <div className="absolute -inset-1 bg-gradient-to-r from-primary/20 to-secondary/20 blur-xl opacity-50 animate-pulse"></div>
            </span>
          </h1>
          ...
          >
            ...
            <span className="text-primary typing-cursor w-full sm:w-auto max-w-[280px] sm:max-w-[350px] md:max-w-[400px] text-center sm:text-left relative">
              {currentText}
          ...
          >
            <Button
              size="lg"
              className="group relative overflow-hidden spring-gradient hover:shadow-2xl hover:shadow-primary/25 transition-all duration-300 transform hover:scale-105 neon-border w-full sm:w-auto pulse-glow"
            >
          ...
          <div className="flex justify-center space-x-6 sm:space-x-8 mb-4 rotate-in" style={{ animationDelay: "1.3s" }}>
            {[
              ...
              <Link
                key={social.label}
                href={social.href}
                className={`group relative p-3 sm:p-4 rounded-full glass-effect-strong neon-border transition-all duration-300 transform hover:scale-110 hover:rotate-12 ${social.color} float-gentle`}
                style={{ animationDelay: `${1.5 + index * 0.2}s` }}
              >
                <social.icon className="h-5 w-5 sm:h-6 sm:w-6 text-muted-foreground group-hover:scale-110 transition-all duration-300" />
                ...
                {/* Enhanced tooltip */}
                <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 glass-effect border border-primary/20 px-2 py-1 rounded text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
                  {social.label}
                </div>
              </Link>
            ))}
      ...
      <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 float-gentle">
        <div className="w-5 h-8 sm:w-6 sm:h-10 border-2 border-primary rounded-full flex justify-center relative neon-border pulse-glow">
          <div className="w-1 h-2 sm:h-3 bg-primary rounded-full mt-1 sm:mt-2 animate-pulse shadow-lg shadow-primary/50"></div>
